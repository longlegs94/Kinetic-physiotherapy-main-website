    ...
    >
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div>
          <label htmlFor="icbc-claim" className={labelClass}>
            ICBC claim number <span className="font-normal text-charcoal/70">(optional)</span>
          </label>
          <input
            id="icbc-claim"
            name="claim_number"
        ...
        <div>
          <label htmlFor="icbc-callback-time" className={labelClass}>
            Best time to call <span className="font-normal text-charcoal/70">(optional)</span>
          </label>
      ...
      <div>
        <label htmlFor="icbc-message" className={labelClass}>
          ...
          <span className="font-normal text-charcoal/70">(optional)</span>
        </label>
        <textarea
          id="icbc-message"
          name="message"
