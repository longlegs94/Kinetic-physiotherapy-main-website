  ...
  return (
    <section className="flex min-h-[70vh] items-center bg-warm-white pt-28">
      <Container className="text-center">
        ...
        <h1 className="mt-4 text-section-h2 font-bold text-charcoal">Something went wrong.</h1>
        ...
        <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
          <button
            type="button"
            onClick={reset}
            className="group inline-flex items-center justify-center gap-2 rounded-pill bg-mint px-7 py-4 text-[17px] font-semibold text-charcoal transition-all duration-200 ease-premium hover:shadow-button-hover hover:-translate-y-0.5"
          >
            Try again
          </button>
